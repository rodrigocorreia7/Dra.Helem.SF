  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 pointer-events-auto">
        ...
        {showTooltip && (
          ...
          >
            <button
              ...
              className="absolute -top-2 -left-2 flex h-5 w-5 items-center justify-center rounded-full bg-slate-800 text-xs text-white hover:bg-slate-700"
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-[#075e54] text-white shadow-2xl transition-all duration-300 hover:scale-105 hover:bg-[#0b7367] focus:outline-none focus:ring-4 focus:ring-emerald-500/50"
